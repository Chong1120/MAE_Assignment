...
import '../feature/admin_specific_f.dart';

class AdminSpecific extends StatefulWidget {
  final String userId; 
  final String suserId;
  const AdminSpecific({super.key, required this.userId, required this.suserId});

  @override
  _AdminSpecificState createState() => _AdminSpecificState();
}

class _AdminSpecificState extends State<AdminSpecific> {

...
class AdminHomeReported extends StatefulWidget {
  final String userId;
  const AdminHomeReported({super.key, required this.userId});

  @override
  _AdminHomeReportedState createState() => _AdminHomeReportedState();
}

class _AdminHomeReportedState extends State<AdminHomeReported> {
  ...
  Future<void> fetchPosts() async {
    final fetchedPosts = await getPosts('disapproved', true);
    setState(() {
      posts = fetchedPosts;
    });
  }
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () => _showReportDialog(post['id'], 'approved'),
                      ),
                    ],
                  ),
                ],
